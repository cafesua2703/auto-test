...
<section>
	<article  id="article1">
		  <c:url value="/customer/customer-save" var="urlSave"/>
		  <c:url value="/customer/customer-view" var="urlView"/>
		  <c:url value="/customer/customer-update" var="urlUpdate"/>
		  <c:url value="/customer/customerDelete" var="urlDelete"/>
		  <h1>List Customer:</h1>

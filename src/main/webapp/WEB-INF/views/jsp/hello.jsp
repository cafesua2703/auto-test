...
<body>
	<header class="header-banner">
		<div class="container-width">
			...
			<div class="sub-lead-title">All text blocks could be edited
				easily with double clicking on it. You can create new text blocks
	...
	<section class="flex-sect">
		<div class="container-width">
			...
			<div class="flex-desc">With flexbox system you're able to build
				complex layouts easily and with free responsivity</div>
			<div class="cards">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="card-desc">Lorem ipsum dolor sit amet,
		...
		<div class="container-width">
			<div class="am-container">
				...
				<div class="am-content">
					...
					<div class="am-desc">You can create image blocks with the
						command from the left panel and edit them with double click</div>
					<div class="am-post">Image uploading is not allowed in this
						demo</div>
				</div>
			</div>
		</div>
	...
	<section class="blk-sect">
		<div class="container-width">
			...
			<div class="blk-desc">Each element in HTML page could be seen
				as a block. On the left panel you could find different kind of
				blocks that you can create, move and style</div>
			...
			<div class="badges">
				<div class="badge">
					...
					<div class="badge-body">
						...
						<div class="badge-desc">Lorem ipsum dolor sit amet,
							consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
							labore ipsum dolor sit</div>
					</div>
					<div class="badge-foot">
						<span class="badge-link">f</span><span class="badge-link">t</span><span
							class="badge-link">ln</span>
					</div>
				</div>
				<div class="badge">
					<div class="badge-header"></div>
			...
			<div class="footer-container">
				...
				<div class="form-sub">
					<div class="foot-form-cont">
						...
						<div class="foot-form-desc">Subscribe to our newsletter to
							receive exclusive offers and the latest news</div>
						<input name="name" placeholder="Name" class="sub-input" /><input
							name="email" placeholder="Email" class="sub-input" />

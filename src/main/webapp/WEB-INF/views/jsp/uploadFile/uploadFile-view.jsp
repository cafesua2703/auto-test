...
<article  id="article1">
  ...
  <h1>View uploadFile:</h1>  
  UploadFile ID: ${uploadFile.id} <br/>
  UploadFile Name: ${uploadFile.fileName} <br/>
  UploadFile Data:  <br/>
  <img src="data:image/jpeg;base64,<c:out value='${uploadFile.base64}'/>"  >
  </article>
  </section>
</body>
